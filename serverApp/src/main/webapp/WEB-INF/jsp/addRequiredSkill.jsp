...
<div id="wrap">
  Добавляем RequiredSkill в <c:out value="${job.caption}"/><br/>

  <form method="POST" action="/addRequiredSkill">
...
<div id="footer">
  <div class="container">
    <p class="muted licensed">Создано <a href="http://vk.com/id12579619">Юрой</a> и <a href="http://vk.com/id20890267">Романом</a>.
    </p>
  </div>
</div>
